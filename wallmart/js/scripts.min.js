...
d||(ua="")};g.setStyle=function(a,b,c){var d=a.style;if(b=b.replace(L,M).replace("-",""),"zIndex"===b)isNaN(c)?d[b]=c:d[b]=""+(0|c);else if("float"===b)d.styleFloat=d.cssFloat=c;else try{R&&(d[R+b.slice(0,1).toUpperCase()+b.slice(1)]=c),d[b]=c}catch(e){}};var ha,ia,ja,ka,la,ma,na,oa,pa,qa,ra,sa,ta,ua,va,wa=g.addEvent=function(b,c,d){var e=function(b){return b=b||a.event,b.target||(b.target=b.srcElement),b.preventDefault||(b.preventDefault=function(){b.returnValue=!1,b.defaultPrevented=!0}),d.call(this,b)};c=c.split(" ");for(var f,g=0,h=c.length;g<h;g++)f=c[g],b.addEventListener?b.addEventListener(f,d,!1):b.attachEvent("on"+f,e),Ua.push({element:b,name:f,listener:d})},xa=g.removeEvent=function(a,b,c){b=b.split(" ");for(var d=0,e=b.length;d<e;d++)a.removeEventListener?a.removeEventListener(b[d],c,!1):a.detachEvent("on"+b[d],c)},ya=function(){for(var a,b=0,c=Ua.length;b<c;b++)a=Ua[b],xa(a.element,a.name,a.listener);Ua=[]},za=function(a,b,c){ka.keyframe&&ka.keyframe.call(ha,a,b,c)},Aa=function(){var a=ha.getScrollTop();Ja=0,la&&!Sa&&(f.style.height=""),Y(),la&&!Sa&&(f.style.height=Ja+e.clientHeight+"px"),Sa?ha.setScrollTop(i.min(ha.getScrollTop(),Ja)):ha.setScrollTop(a,!0),sa=!0},Ba=function(){var a,b,c=e.clientHeight,d={};for(a in ma)b=ma[a],"function"==typeof b?b=b.call(ha):/p$/.test(b)&&(b=b.slice(0,-1)/100*c),d[a]=b;return d},Ca=function(){var a,b=0;return ja&&(b=i.max(ja.offsetHeight,ja.scrollHeight)),a=i.max(b,f.scrollHeight,f.offsetHeight,e.scrollHeight,e.offsetHeight,e.clientHeight),a-e.clientHeight},Da=function(b){var c="className";return a.SVGElement&&b instanceof a.SVGElement&&(b=b[c],c="baseVal"),b[c]},Ea=function(b,d,e){var f="className";if(a.SVGElement&&b instanceof a.SVGElement&&(b=b[f],f="baseVal"),e===c)return void(b[f]=d);for(var g=b[f],h=0,i=e.length;h<i;h++)g=Ga(g).replace(Ga(e[h])," ");g=Fa(g);for(var j=0,k=d.length;j<k;j++)Ga(g).indexOf(Ga(d[j]))===-1&&(g+=" "+d[j]);b[f]=Fa(g)},Fa=function(a){return a.replace(H,"")},Ga=function(a){return" "+a+" "},Ha=Date.now||function(){return+new Date},Ia=function(a,b){return a.frame-b.frame},Ja=0,Ka=1,La="down",Ma=-1,Na=Ha(),Oa=0,Pa=0,Qa=!1,Ra=0,Sa=!1,Ta=0,Ua=[];"function"==typeof define&&define.amd?define([],function(){return g}):"undefined"!=typeof module&&module.exports?module.exports=g:a.skrollr=g}(window,document);var NewObjects={run:function(){function a(){var a=document.getElementById("template").text,b=document.getElementById("wallmart_content"),c=Page.geometries;console.log(31,b),_.each(Page.filenames,function(d){var e=new THREE.Scene,f=document.createElement("div");f.className="list-item",f.innerHTML=a,e.userData.element=f.querySelector(".scene"),b.appendChild(f);var h=new THREE.PerspectiveCamera(50,1,1,10);h.position.z=5,e.userData.camera=h;var i=new THREE.TrackballControls(e.userData.camera,e.userData.element);i.minDistance=2,i.maxDistance=5,i.enablePan=!1,i.enableZoom=!1,i.rotateSpeed=10,e.userData.controls=i;var j=_.find(c,function(a){return a.name==d}),k=new THREE.MeshPhongMaterial({color:15658734,specular:11184810,shininess:0}),l=new THREE.Mesh(j,k);l.position.set(0,0,0),l.rotation.set(-Math.PI/2,-Math.PI/12,0);var m=.045;"palestinian_village"===d?m*=.825:"checkpoint"!==d&&"menorah"!==d||(m*=1.2),l.scale.set(m,m,m),e.add(l),e.add(new THREE.HemisphereLight(11184810,10066329));var n=new THREE.DirectionalLight(16777215,.5);n.position.set(1,1,1),e.add(n),g.push(e)}),e=new THREE.WebGLRenderer({canvas:f,antialias:!0,alpha:!0}),e.setClearColor(16777215,0),e.setPixelRatio(window.devicePixelRatio)}function b(){var a=f.clientWidth,b=f.clientHeight;f.width===a&&f.height==b||e.setSize(a,b,!1)}function c(){setTimeout(function(){requestAnimationFrame(function(){c()})},1e3/15),d()}function d(){b(),e.setClearColor(16777215,0),e.setScissorTest(!1),e.clear(),e.setScissorTest(!0),g.forEach(function(a){a.children[0].rotation.z=5e-5*Date.now();var b=a.userData.element,c=b.getBoundingClientRect();if(!(c.bottom<0||c.top>e.domElement.clientHeight||c.right<0||c.left>e.domElement.clientWidth)){var d=c.right-c.left,f=c.bottom-c.top,g=c.left,h=c.top;e.setViewport(g,h,d,f),e.setScissor(g,h,d,f);var i=a.userData.camera;a.userData.controls.update(),e.render(a,i)}})}Detector.webgl||Detector.addGetWebGLMessage();var e,f=document.getElementById("wallmart_canvas"),g=[];a(),c()}},Objects={init:function(){function a(){e=document.getElementById("canvas");var a=document.getElementById("objects_wrapper"),b=Page.geometries;_.each(Page.filenames,function(c){var d=new THREE.Scene;element=document.createElement("div"),element.className="list-item",element.innerHTML="<div class='scene'></div>",d.userData.element=element.querySelector(".scene"),a.appendChild(element);var e=new THREE.PerspectiveCamera(50,1,1,10);e.position.z=5,d.userData.camera=e;var f=new THREE.TrackballControls(d.userData.camera,d.userData.element);f.minDistance=2,f.maxDistance=5,f.enablePan=!1,f.enableZoom=!1,f.rotateSpeed=10,d.userData.controls=f;var g=new THREE.MeshPhongMaterial({color:15658734,specular:11184810,shininess:0}),i=_.find(b,function(a){return a.name==c}),j=new THREE.Mesh(i,g);j.position.set(0,0,0),j.rotation.set(-Math.PI/2,-Math.PI/12,0);var k=.045;"palestinian_village"===c?k*=.825:"checkpoint"!==c&&"menorah"!==c||(k*=1.2),j.scale.set(k,k,k),d.add(j),d.add(new THREE.HemisphereLight(11184810,10066329));var l=new THREE.DirectionalLight(16777215,.5);l.position.set(1,1,1),d.add(l),d.name=c,h.push(d),$("#canvas").fadeIn(1e3)}),f=new THREE.WebGLRenderer({canvas:e,antialias:!0,alpha:!0}),f.setClearColor(16777215,0),console.log(119,"Pixel ratio: ",window.devicePixelRatio),f.setPixelRatio(window.devicePixelRatio/1.244),g.canvasSize()}function b(){var a=e.clientWidth,b=e.clientHeight;a=$("#objects_wrapper").width(),$("#canvas").css({width:a,height:b}),e.width===a&&e.height==b||f.setSize(a,b,!1)}function c(){setTimeout(function(){requestAnimationFrame(function(){c()})},500),d()}function d(){b();$(window).scrollTop(),$(window).height();f.setClearColor(16777215,0),f.setScissorTest(!1),f.clear(),f.setScissorTest(!0);var a=1;h.forEach(function(b){b.children[0].rotation.z=5e-5*Date.now();var c=b.userData.element,d=c.getBoundingClientRect(),e=d.top+window.scrollY,g=d.bottom+window.scrollY;g<0||e>f.domElement.clientHeight||d.right<0||d.left>f.domElement.clientWidth;var h=d.right-d.left,i=g-e,j=d.left-60,k=e;"pillbox"===b.name&&console.log(213,k,i),f.setViewport(j,k,h,i),f.setClearColor(16776960,1),f.setScissor(j,k,h,i),f.clearColor();var l=b.userData.camera;l.aspect=h/i,l.updateProjectionMatrix(),b.userData.controls.update(),f.render(b,l),a++})}console.log("Objects.init"),Detector.webgl||Detector.addGetWebGLMessage();var e,f,g=this,h=[];a(),c()},canvasSize:function(){console.log(216,"Objects.canvasSize"),console.log(218,$("#objects_wrapper").height(),$("#canvas").height()),$("#canvas").css({width:$("#objects_wrapper").width(),height:$("#objects_wrapper").height()+$(window).height()})}},Page={filenames:["pillbox","separation_wall","palestinian_village","settlers_house","gate","checkpoint","mezuzah","menorah","keychain","chocolate_mould","pendant","earring"],geometries:[],currentNoCards:9,init:function(){console.log("Page.init"),Info.init();var a=this;this.imagesSize(),Info.detectMobile()||(this.scrollInit(),this.s=skrollr.init({forceHeight:!1})),this.bindEvents(),"true"!==$("#wrapper").attr("data-bg")&&this.geometryLoader(),_.delay(function(){a.wrapperHeightCheck()},2e3)},bindEvents:function(){console.log("Page.bindEvents");var a=this;$(window).on("resize",_.throttle(function(){a.imagesSize(),Objects.canvasSize(),a.wrapperHeightCheck()},1e3))},imagesSize:function(){console.log("Page.imagesSize");var a=$(window).width()/$(window).height();$("#postcards li").find(".postcard_image").each(function(){var b,c,d=parseFloat($(this).attr("data-ratio"));b=a>d?$(window).width():$(window).height()*d,c=b<=600?$(this).attr("data-mlg"):b>600&&b<=768?$(this).attr("data-lrg"):b>768&&b<=900?$(this).attr("data-xlg"):$(this).attr("data-ulg");var e=$(this).attr("style").split('url("')[1];void 0!==e&&(e=e.split('")')[0]),c!==e&&(console.log("Source changed."),$(this).attr("style",'background-image:url("'+c+'")'))})},scrollInit:function(a){console.log("Page.scrollInit");$(window).height();$("#postcards li").each(function(a){$(this).find(".postcard_image").attr({"data-top-bottom":"top:    0%","data-bottom-top":"top:-11.2%"})})},geometryLoader:function(){console.log("Page.geometryLoader");var a=this;_.each(this.filenames,function(b){var c=new THREE.STLLoader;c.load(TEMPLATE+"/assets/objects/"+b+"_centered.stl",function(c){c.name=b,a.geometries.push(c),"palestinian_village"===b&&_.delay(function(){NewObjects.run(),a.captionsLoader()},500)})})},captionsLoader:function(){console.log("Page.captionsLoader");var a=this;$("#wallmart_content .list-item").each(function(b){console.log(165);var c="<div class='caption'>";c+="<img src='"+TEMPLATE+"/assets/img/caption_"+a.filenames[b]+".svg' />",c+="</div>",$(this).append(c),$(this).find(".caption").fadeIn(1e3)})},wrapperHeightCheck:function(){console.log("Page.wrapperHeightCheck");var a=$(window).height(),b=1.5*a+$("#wallmart_content").height(),c=$("#wrapper").height();console.log(172,b,c);var d=b-c,e=Math.ceil(d/a),f=this.currentNoCards+e;console.log(253,this.currentNoCards,f),this.currentNoCards!==f&&($("#wrapper").css("height",100*f+"vh"),this.currentNoCards=f)}};$(document).on("ready",function(){Page.init()});