...
MM:"%d months",y:"a year",yy:"%d years"},Qd=r.prototype;Qd._calendar=Kd,Qd.calendar=Yb,Qd._longDateFormat=Ld,Qd.longDateFormat=Zb,Qd._invalidDate=Md,Qd.invalidDate=$b,Qd._ordinal=Nd,Qd.ordinal=_b,Qd._ordinalParse=Od,Qd.preparse=ac,Qd.postformat=ac,Qd._relativeTime=Pd,Qd.relativeTime=bc,Qd.pastFuture=cc,Qd.set=dc,Qd.months=S,Qd._months=id,Qd.monthsShort=T,Qd._monthsShort=jd,Qd.monthsParse=U,Qd.week=ia,Qd._week=qd,Qd.firstDayOfYear=ka,Qd.firstDayOfWeek=ja,Qd.weekdays=Ib,Qd._weekdays=Ad,Qd.weekdaysMin=Kb,Qd._weekdaysMin=Cd,Qd.weekdaysShort=Jb,Qd._weekdaysShort=Bd,Qd.weekdaysParse=Lb,Qd.isPM=Rb,Qd._meridiemParse=Dd,Qd.meridiem=Sb,v("en",{ordinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(a){var b=a%10,c=1===p(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th";return a+c}}),a.lang=$("moment.lang is deprecated. Use moment.locale instead.",v),a.langData=$("moment.langData is deprecated. Use moment.localeData instead.",x);var Rd=Math.abs,Sd=uc("ms"),Td=uc("s"),Ud=uc("m"),Vd=uc("h"),Wd=uc("d"),Xd=uc("w"),Yd=uc("M"),Zd=uc("y"),$d=wc("milliseconds"),_d=wc("seconds"),ae=wc("minutes"),be=wc("hours"),ce=wc("days"),de=wc("months"),ee=wc("years"),fe=Math.round,ge={s:45,m:45,h:22,d:26,M:11},he=Math.abs,ie=Ea.prototype;ie.abs=lc,ie.add=nc,ie.subtract=oc,ie.as=sc,ie.asMilliseconds=Sd,ie.asSeconds=Td,ie.asMinutes=Ud,ie.asHours=Vd,ie.asDays=Wd,ie.asWeeks=Xd,ie.asMonths=Yd,ie.asYears=Zd,ie.valueOf=tc,ie._bubble=pc,ie.get=vc,ie.milliseconds=$d,ie.seconds=_d,ie.minutes=ae,ie.hours=be,ie.days=ce,ie.weeks=xc,ie.months=de,ie.years=ee,ie.humanize=Bc,ie.toISOString=Cc,ie.toString=Cc,ie.toJSON=Cc,ie.locale=pb,ie.localeData=qb,ie.toIsoString=$("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",Cc),ie.lang=yd,G("X",0,0,"unix"),G("x",0,0,"valueOf"),L("x",Xc),L("X",Zc),O("X",function(a,b,c){c._d=new Date(1e3*parseFloat(a,10))}),O("x",function(a,b,c){c._d=new Date(p(a))}),a.version="2.10.3",b(Aa),a.fn=Jd,a.min=Ca,a.max=Da,a.utc=h,a.unix=Wb,a.months=gc,a.isDate=d,a.locale=v,a.invalid=l,a.duration=Va,a.isMoment=o,a.weekdays=ic,a.parseZone=Xb,a.localeData=x,a.isDuration=Fa,a.monthsShort=hc,a.weekdaysMin=kc,a.defineLocale=w,a.weekdaysShort=jc,a.normalizeUnits=z,a.relativeTimeThreshold=Ac;var je=a;return je});var Page={winH:$(window).height(),winW:$(window).width(),videoVisible:!1,init:function(){console.log("Page.init"),Info.init(),this.bindEvents(),this.videoInit()},bindEvents:function(){console.log("Page.bindEvents");var a=this;$("#restart_button a").on("click",function(b){b.preventDefault(),a.restartVideo()}),$(window).on("resize",_.throttle(function(){a.winH=$(window).height(),a.winW=$(window).width(),a.videosResize()},250))},videoInit:function(){console.log("Page.videoInit");var a=this;if(Info.detectMobile())console.log(62,"Mobile"),$(".video").each(function(){var a=$(this).attr("data-src"),b=a.replace("?background=1","?autoplay=0");console.log(67,b),$(this).attr("data-src",b)}),this.mobileInit();else{$("#video").attr("src",$("#video").attr("data-src")),console.log(66,$("#video").attr("src")),this.videoPlayer=new Vimeo.Player("video"),this.videosResize(),$("#restart_button").show();for(var b,c=new Date,d=c.getMinutes(),e=c.getSeconds(),f=60*d+e,g=[],h=0;h<3600;){var i=h;g.push(i),h+=431}for(var j=g.length-1;j>=0;--j)if(f>g[j]){b=f-g[j];break}_.defer(function(){a.videoPlayer.setCurrentTime(b).then(function(b){a.videoPlayer.play(),console.log(77,"Video started at "+b+" seconds")})}),this.timeSinceLaunch(),this.videoPlayer.on("timeupdate",_.throttle(function(b){a.videoVisible||$("#video_wrapper").fadeIn(1e3)},1e3))}},videosResize:function(){console.log("Page.videosResize");var a=this;$("iframe").each(function(){var b=a.winH/a.winW,c=$(this),d=parseInt(c.attr("height"))/parseInt(c.attr("width"));if(console.log(104,b,c.attr("height"),c.attr("width")),b>d){console.log("Full height");var e=a.winH/d/a.winW*100;c.css({width:e+"%","margin-left":0-(e-100)/2+"%","margin-top":"",height:"100%"})}else{console.log("Full width");var f=a.winW*d/a.winH*100;c.css({width:"100%","margin-left":"","margin-top":0-(a.winW*d-a.winH),height:f+"%"})}})},timeSinceLaunch:function(){console.log("Page.timeSinceLaunch"),setInterval(function(){var a=moment(new Date),b=moment([2017,7,23]),c=moment.duration(a.diff(b)).as("seconds"),d=c/60/60,e=60*(d-Math.floor(d)),f=60*(e-Math.floor(e)),g=Math.floor(d)+"&#186;"+Math.floor(e)+"'"+Math.floor(f)+'"';$("#timer").html(g)},1e3)},restartVideo:function(){console.log("Page.restartVideo");var a=this;$("#video_wrapper").hide(),this.videoPlayer.setCurrentTime(0).then(function(b){a.videoPlayer.play(),console.log(178,"Video started at "+b+" seconds"),_.defer(function(){$("#video_wrapper").fadeIn()})}),$("#restart_button").fadeOut()},mobileInit:function(){console.log("Page.mobileInit"),$("#video").attr("src",$("#video").attr("data-src")).css({"pointer-events":"auto"}),this.videoPlayer=new Vimeo.Player("video"),$("#video_wrapper").fadeIn(1e3)}};$(document).on("ready",function(){Page.init()});