...
var Page={winW:$(window).width(),winH:$(window).height(),init:function(){console.log("Page.init"),Webcam.init(),this.bindEvents(),this.contentSize(),this.slideshowsLoad()},bindEvents:function(){console.log("Page.bindEvents");var a=this;$(".group_one").on("mouseover",function(){$(".group_one").css({filter:"grayscale(0%)"})}),$(".group_one").on("mouseout",function(){$(".group_one").css({filter:""})}),$(".group_two").on("mouseover",function(){$(".group_two").css({filter:"grayscale(0%)"})}),$(".group_two").on("mouseout",function(){$(".group_two").css({filter:""})}),$(window).on("resize",_.throttle(function(){a.winW=$(window).width(),a.winH=$(window).height(),a.contentSize()},50))},contentSize:function(){console.log("Page.contentSize");var a,b=this.winW/this.winH,c=1.6,d=0,e=this;b>c?(a=e.winW,d=0,frameTop=0-(a/1.6-e.winH)/2):(a=e.winH*c,d=0-(a-e.winW)/2,frameTop=0),$("#content_frame").css({width:a,height:a/1.6,left:d,top:frameTop})},slideshowsLoad:function(){console.log("Page.slideshowsLoad");var a=this;$.ajax({url:ROOT+"/wp-json/wp/v2/posts/14",success:function(b){a.slideshowData=b.acf,a.loadWebcamArchive(),Webcam.imagesFrames=b.acf.webcam_frames,Webcam.imagesDraggable=b.acf.webcam_draggable,Webcam.imagesTracking=b.acf.webcam_tracking,Webcam.initialState(b.acf.webcam_archive_images)},error:function(a){console.log(a)}})},loadWebcamArchive:function(){console.log("Page.loadWebcamArchive");var a=this;$.ajax({type:"GET",url:ROOT+"/_tmp_dir/get_server_files.php",dataType:"json"}).done(function(b){a.webcamImages=b,a.slideshowsInit()})},shuffle:function(a){var b,c,d;for(d=a.length;d;d--)b=Math.floor(Math.random()*d),c=a[d-1],a[d-1]=a[b],a[b]=c},slideshowsInit:function(){function a(a){console.log("Page.slideshowsInit.sendToFrames");for(var e=d.slideshowContent.length-1;e>=0;e--){var f=d.slideshowContent[e];"string"==typeof f&&f.indexOf("images/img_")>-1?b.length<2&&b.push(d.slideshowContent.splice(e,1)):"image"in f&&f.image.height>f.image.width?b.length<2&&b.push(d.slideshowContent.splice(e,1)):c.length<2&&c.push(d.slideshowContent.splice(e,1))}var g=4e3,h=8e3,i=15e3;a&&(g=0,h=0,i=0),d.injectImage("#slideshow_1",b[0]),_.delay(function(){d.injectImage("#slideshow_2",c[0])},g),_.delay(function(){d.injectImage("#slideshow_3",c[1])},h),_.delay(function(){d.injectImage("#slideshow_4",b[1]),b.length=0,c.length=0},i)}console.log("Page.slideshowsInit"),this.slideshowContent=this.slideshowData.images.concat(this.slideshowData.movies).concat(this.webcamImages),this.shuffle(this.slideshowContent);var b=[],c=[],d=this;a(!0),setInterval(function(){a()},2e4)},injectImage:function(a,b){console.log("Page.injectImage"),"#webcam_initial_image"!==a&&this.slideshowContent.unshift(b[0]);var c=$(a).width(),d=$(a).height(),e=this;if("string"==typeof b[0]||"image"in b[0]){var f;if("string"==typeof b[0])f=MAIN_ROOT+"_tmp_dir/"+b;else{var g=b[0].image.sizes;"#slideshow_1"!==a&&"#slideshow_4"!==a||(c=d),f=c<=400?g.thumbnail:c>400&&c<=600?g.medium:c>600&&c<=768?g.medium_large:c>768&&c<=900?g.large:c>900&&c<=1200?g.extralarge:g.ultralarge}$(a).css("background-image","url('"+f+"')")}else $(a).append("<video id='video' muted autoplay><source src='"+b[0].movie.url+"' type='video/mp4'></video>"),$("#video").on("ended",function(){for(var b=e.slideshowContent.length-1;b>=0;b--){var c=e.slideshowContent[b];if("image"in c&&c.image.height<c.image.width){var d=e.slideshowContent.splice(b,1);e.injectImage(a,d);break}}$(this).remove()})}};$(document).on("ready",function(){Page.init()});var Webcam={captureDisabled:!1,init:function(){console.log("Webcam.init"),this.bindEvents()},bindEvents:function(){console.log("Webcam.bindEvents");var a=this;$("#webcam_button_init").on("click",function(){a.getUserMedia()}),$("#webcam_button_close").on("click",function(){a.webcamClose()}),$("#webcam_button_refresh").on("click",function(){a.loadImages()}),$("#webcam_button_take").on("click",function(){a.captureImageClick($(this))}),$("#webcam_success_yes").on("click",function(){a.saveCaptureToDatabase(),a.webcamClose()}),$("#webcam_success_no").on("click",function(){a.webcamClose()})},initialState:function(a){console.log("Webcam.initialState");var b=parseInt(Math.random()*a.length),c=[a[b]];Page.injectImage("#webcam_initial_image",c)},getUserMedia:function(){console.log("Webcam.getUserMedia"),$("#webcam_initial_image").hide(),$("#webcam_button_init").hide();var a=!0;a?this.webcamLoad():$("#webcam_access_screen").show()},webcamLoad:function(){console.log("Webcam.webcamLoad"),$("#webcam_access_screen").hide(),$("#webcam_video").show(),$("#canvas").show(),$("#webcam_loaded_buttons").show().children().show(),this.trackingInit()},loadImages:function(){console.log("Webcam.loadImages"),this.frame_image=new Image,this.frame_image.src=this.getFrameImage(),this.tracking_image=new Image,this.tracking_image.src=this.getTrackingImage(),this.static_image=new Image,this.static_image.src=this.getStaticImage()},trackingInit:function(){console.log("Webcam.trackingInit");var a=this;this.video=document.getElementById("webcam_video"),this.canvas=document.getElementById("canvas"),this.context=canvas.getContext("2d");var b=$("#webcam_video").height(),c=1.3333*b;$("#canvas").attr({height:b,width:c}).css({height:b,width:c}),this.tracker=new tracking.ObjectTracker("face"),this.tracker.setInitialScale(1.4),this.tracker.setStepSize(1.1),this.tracker.setEdgesDensity(.1),tracking.track("#webcam_video",this.tracker,{camera:!0});var d=(c-.7*b)/2;this.loadImages(),this.tracker.on("track",_.throttle(function(c){a.context.clearRect(0,0,a.canvas.width,a.canvas.height),a.context.drawImage(a.frame_image,d,.05*b,.7*b,.9*b),c.data.forEach(function(b){a.context.drawImage(a.tracking_image,b.x,b.y,b.width,b.height)})},100))},getTrackingImage:function(){console.log("Webcam.getTrackingImage");var a=this.imagesTracking;Page.shuffle(a);var b=a[0];return b.tracking_image.url},getFrameImage:function(){console.log("Webcam.getFrameImage");var a=this.imagesFrames;Page.shuffle(a);var b=a[0];return b.frame_image.sizes.extralarge},getStaticImage:function(){console.log("Webcam.getStaticImage")},captureImageClick:function(a){console.log("Webcam.captureImageClick"),this.captureDisabled=!0;var b=new Date,c=("0"+b.getDate()).slice(-2),d=("0"+(b.getMonth()+1)).slice(-2),e=b.getFullYear(),f=("0"+b.getHours()).slice(-2),g=("0"+b.getMinutes()).slice(-2),h=("0"+b.getSeconds()).slice(-2),i=c+"-"+d+"-"+e,j=f+"."+g+"."+h;a.attr({download:"Arabi Gharbi "+i+" at "+j+".png",href:this.captureImage()}),$("#webcam_loaded_buttons").hide(),$("#webcam_success").show()},captureImage:function(){console.log("Webcam.captureImage");var a=$("#webcam_video").get(0),b=$("#canvas").get(0),c=document.createElement("canvas");c.width=1.67*$("#webcam").width(),c.height=1.67*$("#webcam").height(),console.log(260,a,c.width,c.height);var d=c.getContext("2d"),e=(c.width-1.33*c.height)/2,f=0,g=1.33*c.height,h=c.height;console.log(269,e,f,g,h),d.drawImage(a,e,f,g,h),d.drawImage(b,e,f,g,h);var i=document.createElement("img");return i.src=c.toDataURL(),this.currentCapture=i.src,i.src},saveCaptureToDatabase:function(){console.log("Webcam.saveCaptureToDatabase"),$.ajax({type:"POST",url:"save_image/",data:{imgBase64:this.currentCapture}}).done(function(a){console.log("Image saved.")})},webcamClose:function(){console.log("Webcam.webcamClose"),$("#webcam_success").hide(),$("#webcam_video").hide(),$("#canvas").hide(),$("#webcam_loaded_buttons").hide(),$("#webcam_access_screen").hide(),$("#webcam_initial_image").show(),$("#webcam_button_init").show()}};