...
!function(a,b,c){function d(a,b){return typeof a===b}function e(){var a,b,c,e,f,g,h;for(var i in t)if(t.hasOwnProperty(i)){if(a=[],b=t[i],b.name&&(a.push(b.name.toLowerCase()),b.options&&b.options.aliases&&b.options.aliases.length))for(c=0;c<b.options.aliases.length;c++)a.push(b.options.aliases[c].toLowerCase());for(e=d(b.fn,"function")?b.fn():b.fn,f=0;f<a.length;f++)g=a[f],h=g.split("."),1===h.length?v[h[0]]=e:(!v[h[0]]||v[h[0]]instanceof Boolean||(v[h[0]]=new Boolean(v[h[0]])),v[h[0]][h[1]]=e),s.push((e?"":"no-")+h.join("-"))}}function f(a){var b=w.className,c=v._config.classPrefix||"";if(x&&(b=b.baseVal),v._config.enableJSClass){var d=new RegExp("(^|\\s)"+c+"no-js(\\s|$)");b=b.replace(d,"$1"+c+"js$2")}v._config.enableClasses&&(b+=" "+c+a.join(" "+c),x?w.className.baseVal=b:w.className=b)}function g(a){return a.replace(/([a-z])-([a-z])/g,function(a,b,c){return b+c.toUpperCase()}).replace(/^-/,"")}function h(a,b){return function(){return a.apply(b,arguments)}}function i(a,b,c){var e;for(var f in a)if(a[f]in b)return c===!1?a[f]:(e=b[a[f]],d(e,"function")?h(e,c||b):e);return!1}function j(a,b){return!!~(""+a).indexOf(b)}function k(){return"function"!=typeof b.createElement?b.createElement(arguments[0]):x?b.createElementNS.call(b,"http://www.w3.org/2000/svg",arguments[0]):b.createElement.apply(b,arguments)}function l(a){return a.replace(/([A-Z])/g,function(a,b){return"-"+b.toLowerCase()}).replace(/^ms-/,"-ms-")}function m(b,c,d){var e;if("getComputedStyle"in a){e=getComputedStyle.call(a,b,c);var f=a.console;if(null!==e)d&&(e=e.getPropertyValue(d));else if(f){var g=f.error?"error":"log";f[g].call(f,"getComputedStyle returning null, its possible modernizr test results are inaccurate")}}else e=!c&&b.currentStyle&&b.currentStyle[d];return e}function n(){var a=b.body;return a||(a=k(x?"svg":"body"),a.fake=!0),a}function o(a,c,d,e){var f,g,h,i,j="modernizr",l=k("div"),m=n();if(parseInt(d,10))for(;d--;)h=k("div"),h.id=e?e[d]:j+(d+1),l.appendChild(h);return f=k("style"),f.type="text/css",f.id="s"+j,(m.fake?m:l).appendChild(f),m.appendChild(l),f.styleSheet?f.styleSheet.cssText=a:f.appendChild(b.createTextNode(a)),l.id=j,m.fake&&(m.style.background="",m.style.overflow="hidden",i=w.style.overflow,w.style.overflow="hidden",w.appendChild(m)),g=c(l,a),m.fake?(m.parentNode.removeChild(m),w.style.overflow=i,w.offsetHeight):l.parentNode.removeChild(l),!!g}function p(b,d){var e=b.length;if("CSS"in a&&"supports"in a.CSS){for(;e--;)if(a.CSS.supports(l(b[e]),d))return!0;return!1}if("CSSSupportsRule"in a){for(var f=[];e--;)f.push("("+l(b[e])+":"+d+")");return f=f.join(" or "),o("@supports ("+f+") { #modernizr { position: absolute; } }",function(a){return"absolute"==m(a,null,"position")})}return c}function q(a,b,e,f){function h(){l&&(delete D.style,delete D.modElem)}if(f=!d(f,"undefined")&&f,!d(e,"undefined")){var i=p(a,e);if(!d(i,"undefined"))return i}for(var l,m,n,o,q,r=["modernizr","tspan","samp"];!D.style&&r.length;)l=!0,D.modElem=k(r.shift()),D.style=D.modElem.style;for(n=a.length,m=0;n>m;m++)if(o=a[m],q=D.style[o],j(o,"-")&&(o=g(o)),D.style[o]!==c){if(f||d(e,"undefined"))return h(),"pfx"!=b||o;try{D.style[o]=e}catch(s){}if(D.style[o]!=q)return h(),"pfx"!=b||o}return h(),!1}function r(a,b,c,e,f){var g=a.charAt(0).toUpperCase()+a.slice(1),h=(a+" "+z.join(g+" ")+g).split(" ");return d(b,"string")||d(b,"undefined")?q(h,b,e,f):(h=(a+" "+B.join(g+" ")+g).split(" "),i(h,b,c))}var s=[],t=[],u={_version:"3.5.0",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(a,b){var c=this;setTimeout(function(){b(c[a])},0)},addTest:function(a,b,c){t.push({name:a,fn:b,options:c})},addAsyncTest:function(a){t.push({name:null,fn:a})}},v=function(){};v.prototype=u,v=new v;var w=b.documentElement,x="svg"===w.nodeName.toLowerCase(),y="Moz O ms Webkit",z=u._config.usePrefixes?y.split(" "):[];u._cssomPrefixes=z;var A=function(b){var d,e=prefixes.length,f=a.CSSRule;if("undefined"==typeof f)return c;if(!b)return!1;if(b=b.replace(/^@/,""),d=b.replace(/-/g,"_").toUpperCase()+"_RULE",d in f)return"@"+b;for(var g=0;e>g;g++){var h=prefixes[g],i=h.toUpperCase()+"_"+d;if(i in f)return"@-"+h.toLowerCase()+"-"+b}return!1};u.atRule=A;var B=u._config.usePrefixes?y.toLowerCase().split(" "):[];u._domPrefixes=B;var C={elem:k("modernizr")};v._q.push(function(){delete C.elem});var D={style:C.elem.style};v._q.unshift(function(){delete D.style}),u.testAllProps=r;var E=u.prefixed=function(a,b,c){return 0===a.indexOf("@")?A(a):(-1!=a.indexOf("-")&&(a=g(a)),b?r(a,b,c):r(a,"pfx"))};v.addTest("getusermedia",!!E("getUserMedia",navigator)),e(),f(s),delete u.addTest,delete u.addAsyncTest;for(var F=0;F<v._q.length;F++)v._q[F]();a.Modernizr=v}(window,document),!function(a,b,c){function d(a,b){return typeof a===b}function e(){var a,b,c,e,f,g,h;for(var i in t)if(t.hasOwnProperty(i)){if(a=[],b=t[i],b.name&&(a.push(b.name.toLowerCase()),b.options&&b.options.aliases&&b.options.aliases.length))for(c=0;c<b.options.aliases.length;c++)a.push(b.options.aliases[c].toLowerCase());for(e=d(b.fn,"function")?b.fn():b.fn,f=0;f<a.length;f++)g=a[f],h=g.split("."),1===h.length?v[h[0]]=e:(!v[h[0]]||v[h[0]]instanceof Boolean||(v[h[0]]=new Boolean(v[h[0]])),v[h[0]][h[1]]=e),s.push((e?"":"no-")+h.join("-"))}}function f(a){var b=w.className,c=v._config.classPrefix||"";if(x&&(b=b.baseVal),v._config.enableJSClass){var d=new RegExp("(^|\\s)"+c+"no-js(\\s|$)");b=b.replace(d,"$1"+c+"js$2")}v._config.enableClasses&&(b+=" "+c+a.join(" "+c),x?w.className.baseVal=b:w.className=b)}function g(a){return a.replace(/([a-z])-([a-z])/g,function(a,b,c){return b+c.toUpperCase()}).replace(/^-/,"")}function h(a,b){return function(){return a.apply(b,arguments)}}function i(a,b,c){var e;for(var f in a)if(a[f]in b)return c===!1?a[f]:(e=b[a[f]],d(e,"function")?h(e,c||b):e);return!1}function j(a,b){return!!~(""+a).indexOf(b)}function k(){return"function"!=typeof b.createElement?b.createElement(arguments[0]):x?b.createElementNS.call(b,"http://www.w3.org/2000/svg",arguments[0]):b.createElement.apply(b,arguments)}function l(a){return a.replace(/([A-Z])/g,function(a,b){return"-"+b.toLowerCase()}).replace(/^ms-/,"-ms-")}function m(b,c,d){var e;if("getComputedStyle"in a){e=getComputedStyle.call(a,b,c);var f=a.console;if(null!==e)d&&(e=e.getPropertyValue(d));else if(f){var g=f.error?"error":"log";f[g].call(f,"getComputedStyle returning null, its possible modernizr test results are inaccurate")}}else e=!c&&b.currentStyle&&b.currentStyle[d];return e}function n(){var a=b.body;return a||(a=k(x?"svg":"body"),a.fake=!0),a}function o(a,c,d,e){var f,g,h,i,j="modernizr",l=k("div"),m=n();if(parseInt(d,10))for(;d--;)h=k("div"),h.id=e?e[d]:j+(d+1),l.appendChild(h);return f=k("style"),f.type="text/css",f.id="s"+j,(m.fake?m:l).appendChild(f),m.appendChild(l),f.styleSheet?f.styleSheet.cssText=a:f.appendChild(b.createTextNode(a)),l.id=j,m.fake&&(m.style.background="",m.style.overflow="hidden",i=w.style.overflow,w.style.overflow="hidden",w.appendChild(m)),g=c(l,a),m.fake?(m.parentNode.removeChild(m),w.style.overflow=i,w.offsetHeight):l.parentNode.removeChild(l),!!g}function p(b,d){var e=b.length;if("CSS"in a&&"supports"in a.CSS){for(;e--;)if(a.CSS.supports(l(b[e]),d))return!0;return!1}if("CSSSupportsRule"in a){for(var f=[];e--;)f.push("("+l(b[e])+":"+d+")");return f=f.join(" or "),o("@supports ("+f+") { #modernizr { position: absolute; } }",function(a){return"absolute"==m(a,null,"position")})}return c}function q(a,b,e,f){function h(){l&&(delete D.style,delete D.modElem)}if(f=!d(f,"undefined")&&f,!d(e,"undefined")){var i=p(a,e);if(!d(i,"undefined"))return i}for(var l,m,n,o,q,r=["modernizr","tspan","samp"];!D.style&&r.length;)l=!0,D.modElem=k(r.shift()),D.style=D.modElem.style;for(n=a.length,m=0;n>m;m++)if(o=a[m],q=D.style[o],j(o,"-")&&(o=g(o)),D.style[o]!==c){if(f||d(e,"undefined"))return h(),"pfx"!=b||o;try{D.style[o]=e}catch(s){}if(D.style[o]!=q)return h(),"pfx"!=b||o}return h(),!1}function r(a,b,c,e,f){var g=a.charAt(0).toUpperCase()+a.slice(1),h=(a+" "+z.join(g+" ")+g).split(" ");return d(b,"string")||d(b,"undefined")?q(h,b,e,f):(h=(a+" "+B.join(g+" ")+g).split(" "),i(h,b,c))}var s=[],t=[],u={_version:"3.5.0",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(a,b){var c=this;setTimeout(function(){b(c[a])},0)},addTest:function(a,b,c){t.push({name:a,fn:b,options:c})},addAsyncTest:function(a){t.push({name:null,fn:a})}},v=function(){};v.prototype=u,v=new v;var w=b.documentElement,x="svg"===w.nodeName.toLowerCase(),y="Moz O ms Webkit",z=u._config.usePrefixes?y.split(" "):[];u._cssomPrefixes=z;var A=function(b){var d,e=prefixes.length,f=a.CSSRule;if("undefined"==typeof f)return c;if(!b)return!1;if(b=b.replace(/^@/,""),d=b.replace(/-/g,"_").toUpperCase()+"_RULE",d in f)return"@"+b;for(var g=0;e>g;g++){var h=prefixes[g],i=h.toUpperCase()+"_"+d;if(i in f)return"@-"+h.toLowerCase()+"-"+b}return!1};u.atRule=A;var B=u._config.usePrefixes?y.toLowerCase().split(" "):[];u._domPrefixes=B;var C={elem:k("modernizr")};v._q.push(function(){delete C.elem});var D={style:C.elem.style};v._q.unshift(function(){delete D.style}),u.testAllProps=r;var E=u.prefixed=function(a,b,c){return 0===a.indexOf("@")?A(a):(-1!=a.indexOf("-")&&(a=g(a)),b?r(a,b,c):r(a,"pfx"))};v.addTest("getusermedia",!!E("getUserMedia",navigator)),e(),f(s),delete u.addTest,delete u.addAsyncTest;for(var F=0;F<v._q.length;F++)v._q[F]();a.Modernizr=v}(window,document);var Page={winW:$(window).width(),winH:$(window).height(),init:function(){console.log("Page.init"),this.muteCheck(),Info.init(),Webcam.init(),this.bindEvents(),this.contentSize(),this.slideshowsLoad(),Twitter.init()},bindEvents:function(){console.log("Page.bindEvents");var a=this;$(".group_one").on("mouseover",function(){$(".group_one").not(".no_filter").css({filter:"grayscale(0%)"})}),$(".group_one").on("mouseout",function(){$(".group_one").not(".no_filter").css({filter:""})}),$(".group_two").on("mouseover",function(){$(".group_two").not(".no_filter").css({filter:"grayscale(0%)"})}),$(".group_two").on("mouseout",function(){$(".group_two").not(".no_filter").css({filter:""})}),$(window).on("resize",_.throttle(function(){a.winW=$(window).width(),a.winH=$(window).height(),a.contentSize()},50))},muteCheck:function(){console.log("Page.muteCheck"),"true"==$("#wrapper").attr("data-bg")&&$("#youtube_playlist").empty()},contentSize:function(){console.log("Page.contentSize");var a,b=this.winW/this.winH,c=1.6,d=0,e=this;b>c?(a=e.winW,d=0,frameTop=0-(a/1.6-e.winH)/2):(a=e.winH*c,d=0-(a-e.winW)/2,frameTop=0),$("#content_frame").css({width:a,height:a/1.6,left:d,top:frameTop});var f=document.getElementById("youtube_playlist").getBoundingClientRect(),g=this.winH-f.top,h=f.right;$("#youtube_playlist iframe").css({width:h,height:g});var i=document.getElementById("twitter_wrapper").getBoundingClientRect(),j=i.bottom,k=i.right-i.left;$("#twitter_wrapper ul").css({width:k,height:j})},slideshowsLoad:function(){console.log("Page.slideshowsLoad");var a=this,b=22;ROOT.indexOf("localhost")>-1&&(b=14),$.ajax({url:ROOT+"/wp-json/wp/v2/posts/"+b,success:function(b){a.slideshowData=b.acf,Webcam.imagesFrames=b.acf.webcam_frames,Webcam.imagesDraggable=b.acf.webcam_draggable,Webcam.imagesTracking=b.acf.webcam_tracking,a.slideshowsInit()},error:function(a){console.log(a)}})},shuffle:function(a){var b,c,d;for(d=a.length;d;d--)b=Math.floor(Math.random()*d),c=a[d-1],a[d-1]=a[b],a[b]=c},slideshowsInit:function(){function a(a){console.log("Page.slideshowsInit.sendToFrames");var e=Math.random();d.movieQuota=0,e>.5&&(d.movieQuota=1);for(var f=d.slideshowContent.length-1;f>=0;f--){var g=d.slideshowContent[f];"movie"in g?!Webcam.running&&c.length<2&&(c.push(d.slideshowContent.splice(f,1)),d.movieQuota=0):"image"in g&&(g.image.height>g.image.width?b.length<2&&b.push(d.slideshowContent.splice(f,1)):c.length<2&&0===d.movieQuota&&c.push(d.slideshowContent.splice(f,1)))}var h=4e3,i=8e3,j=15e3;a&&(h=0,i=0,j=0),d.injectImage("#slideshow_1",b[0]),_.delay(function(){d.injectImage("#slideshow_2",c[0])},h),_.delay(function(){d.injectImage("#slideshow_3",c[1])},i),_.delay(function(){d.injectImage("#slideshow_4",b[1]),b.length=0,c.length=0},j)}console.log("Page.slideshowsInit"),Info.detectMobile()&&$(".slideshow_wrapper").css("filter","none").addClass("no_filter"),this.slideshowContent=this.slideshowData.images.concat(this.slideshowData.movies),this.shuffle(this.slideshowContent);var b=[],c=[],d=this;a(!0),setInterval(function(){a()},2e4)},injectImage:function(a,b){console.log("Page.injectImage"),"#webcam_initial_image"!==a&&this.slideshowContent.unshift(b[0]);var c=$(a).width(),d=$(a).height(),e=this;if("string"==typeof b[0]||"image"in b[0]){var f;if("string"==typeof b[0])f=b;else{var g=b[0].image.sizes;"#slideshow_1"!==a&&"#slideshow_4"!==a||(c=d),f=c<=400?g.medium:c>400&&c<=600?g.medium_large:c>600&&c<=768?g.large:c>768&&c<=900?g.extralarge:g.ultralarge}var h=h=new Image;$(h).attr("src",f).on("load",function(){_.defer(function(){$(a).empty().css("background-image","url('"+f+"')")})})}else{var i="";b[0].movie.width<=b[0].movie.height&&(i="full_width"),$(a).empty().append("<video id='video' class='"+i+"' muted autoplay playsinline><source src='"+b[0].movie.url+"' type='video/mp4'></video>"),$("#video").on("ended",function(){for(var b=e.slideshowContent.length-1;b>=0;b--){var c=e.slideshowContent[b];if("image"in c&&c.image.height<c.image.width){var d=e.slideshowContent.splice(b,1);e.injectImage(a,d);break}}$(this).remove()})}},removeVideos:function(){console.log("Page.removeVideos");var a=this;$(".slideshow_wrapper").each(function(){var b=$(this);$(this).find("video").length&&_.delay(function(){for(var c=a.slideshowContent.length-1;c>=0;c--){var d=a.slideshowContent[c];if("image"in d&&d.image.height<d.image.width){var e=a.slideshowContent.splice(c,1);a.injectImage("#"+b.attr("id"),e);break}}b.empty()},2e3)})}};$(document).on("ready",function(){Page.init()});var Twitter={init:function(){console.log("Twitter.init");var a=this;$.ajax({url:"tweets",type:"GET",success:function(b){"undefined"==typeof b.errors||b.errors.length<1?($.each(b,function(b,c){a.styleTweets(c.id_str)}),_.delay(function(){a.slideshowInit()},500)):$("#tweets_wrapper p:first").text("Response error")},error:function(a){$("#tweets_wrapper p:first").text("Request error")}})},styleTweets:function(a){console.log("Twitter.styleTweets"),$("#twitter_wrapper ul").append("<li id='tweet_"+a+"' class='tweet'></li>");var b=document.getElementById("tweet_"+a);twttr.widgets.createTweet(a,b,{conversation:"all",cards:"visible",linkColor:"#cc0000",theme:"light"}).then(function(a){})},slideshowInit:function(){console.log("Twitter.slideshowInit"),$(".tweet").first().addClass("visible"),setInterval(function(){console.log("Twitter loop."),$(".visible").next().length?$(".visible").removeClass("visible").next().addClass("visible"):($(".visible").removeClass("visible"),$(".tweet").first().addClass("visible"))},8e3)}},Webcam={running:!1,captureDisabled:!1,showCapture:!1,init:function(){console.log("Webcam.init"),this.bindEvents(),Webcam.loadWebcamArchive(),Info.detectMobile()||$("#webcam_button_init").fadeIn()},bindEvents:function(){console.log("Webcam.bindEvents");var a=this;$("#webcam_button_init").on("click",function(){a.getUserMedia()}),$("#webcam_button_close").on("click",function(){a.webcamClose()}),$("#webcam_button_refresh").on("click",function(){a.loadImages()}),$("#webcam_button_take").on("click",function(){a.captureDisabled||a.captureImageClick($(this))}),$("#webcam_success_yes").on("click",function(){a.saveCaptureToDatabase(),a.webcamClose(),a.captureDisabled=!1}),$("#webcam_success_no").on("click",function(){a.webcamClose(),a.captureDisabled=!1})},loadWebcamArchive:function(){console.log("Webcam.loadWebcamArchive");var a=this;console.log(62,ROOT+"/get_archive/"),$.ajax({type:"GET",url:ROOT+"/get_archive/",dataType:"json"}).done(function(b){a.webcamImages=b,Webcam.initialState(a.webcamImages),console.log(72,b)}).error(function(a){console.log(74,a)})},initialState:function(a){console.log("Webcam.initialState");var b=this;Page.shuffle(a);var c=0;Page.injectImage("#webcam_initial_image",a[c]);var d,e=a.length;d=e<5?20:e>=5&&e<10?15:8,this.timer=setInterval(function(){c>=e-1?c=0:c++,console.log(112,b.showCapture),b.showCapture||Page.injectImage("#webcam_initial_image",a[c])},1e3*d)},getUserMedia:function(){console.log("Webcam.getUserMedia"),$("#webcam_initial_image").hide(),$("#webcam_button_init").hide(),Modernizr.getusermedia?($("#webcam_access_screen").show(),this.trackingInit()):$("#webcam_error_screen").show()},accessDenied:function(){console.log("Webcam.accessDenied"),$("#webcam_access_screen").show(),$("#webcam_video").hide(),$("#canvas").hide(),$("#webcam_loaded_buttons").hide().children().hide()},accessSuccess:function(){console.log("Webcam.accessSuccess"),$("#webcam_access_screen").hide(),$("#webcam_video").show(),$("#canvas").show(),$("#webcam_loaded_buttons").show().children().show(),this.running=!0,Page.removeVideos()},loadImages:function(){console.log("Webcam.loadImages"),this.frame_image=new Image,this.frame_image.src=this.getFrameImage(),this.tracking_image=new Image,this.tracking_image.src=this.getTrackingImage()[0],this.tracking_image.ratio=this.getTrackingImage()[1],this.static_image=new Image,this.static_image.src=this.getStaticImage()},trackingInit:function(){console.log("Webcam.trackingInit");var a=this;this.video=document.getElementById("webcam_video"),this.canvas=document.getElementById("canvas"),this.context=canvas.getContext("2d");var b=$("#webcam_video").height(),c=1.3333*b;$("#canvas").attr({height:b,width:c}).css({height:b,width:c}),this.tracker=new tracking.ObjectTracker("face"),this.tracker.setInitialScale(1),this.tracker.setStepSize(1.1),this.tracker.setEdgesDensity(.1),tracking.track("#webcam_video",this.tracker,{camera:!0});var d=(c-.7*b)/2;this.loadImages(),this.tracker.on("track",_.throttle(function(c){a.context.clearRect(0,0,a.canvas.width,a.canvas.height),a.context.drawImage(a.frame_image,d,.05*b,.7*b,.9*b),a.context.drawImage(a.static_image,d,.05*b,.7*b,.9*b),c.data.forEach(function(b){var c=b.height-b.width/a.tracking_image.ratio,d=b.y+c/2;a.context.drawImage(a.tracking_image,b.x,d,b.width,b.width/a.tracking_image.ratio)})},100))},getTrackingImage:function(){console.log("Webcam.getTrackingImage");var a=this.imagesTracking;Page.shuffle(a);var b=a[0],c=[];return c.push(b.tracking_image.url),c.push(b.tracking_image.width/b.tracking_image.height),c},getFrameImage:function(){console.log("Webcam.getFrameImage");var a=this.imagesFrames;Page.shuffle(a);var b=a[0];return b.frame_image.sizes.extralarge},getStaticImage:function(){console.log("Webcam.getStaticImage");var a=this.imagesDraggable;Page.shuffle(a);var b=a[0];return b.draggable_image.sizes.extralarge},captureImageClick:function(a){console.log("Webcam.captureImageClick");var b=$("#cam_click").get(0);b.play();var c=this.captureImage();this.captureDisabled=!0;var d=new Date,e=("0"+d.getDate()).slice(-2),f=("0"+(d.getMonth()+1)).slice(-2),g=d.getFullYear(),h=("0"+d.getHours()).slice(-2),i=("0"+d.getMinutes()).slice(-2),j=("0"+d.getSeconds()).slice(-2),k=e+"-"+f+"-"+g,l=h+"."+i+"."+j;a.attr({download:"Arabi-Arabi "+k+" at "+l+".png",href:c}),$("#webcam_loaded_buttons").hide(),$("#webcam_success").show(),this.showCapture(c)},captureImage:function(){console.log("Webcam.captureImage");var a=$("#webcam_video").get(0),b=$("#canvas").get(0),c=document.createElement("canvas");c.width=1.67*$("#webcam").width(),c.height=1.67*$("#webcam").height();var d=c.getContext("2d"),e=(c.width-1.33*c.height)/2,f=0,g=1.33*c.height,h=c.height;d.drawImage(a,e,f,g,h),d.drawImage(b,e,f,g,h);var i=document.createElement("img");return i.src=c.toDataURL(),this.currentCapture=i.src,i.src},saveCaptureToDatabase:function(){console.log("Webcam.saveCaptureToDatabase");var a=this;$.ajax({type:"POST",url:"save_image/",data:{imgBase64:this.currentCapture}}).done(function(b){var c=MAIN_ROOT+b;a.uploadToComments(c)}).error(function(a){console.log("Error saving to database.")})},uploadToComments:function(a){console.log("Webcam.uploadToComments",a),$("#comment").append(a);var b=$("#commentform");b.submit(function(){console.log(390,"Comment submitted");var a=b.serialize(),c=b.attr("action");return $.ajax({type:"post",url:c,data:a,error:function(a,b,c){console.log(401,a,b,c)},success:function(a,c){"success"==a?console.log(405,c,"Success"):console.log(407,c,"!Success"),b.find("textarea[name=comment]").val("")}}),!1});var c=new MouseEvent("click",{view:window,bubbles:!0,cancelable:!1});$("#submit")[0].dispatchEvent(c)},showCapture:function(a){console.log("Webcam.showCapture");var b=this;Page.injectImage("#webcam_initial_image",a),this.showCapture=!0,setTimeout(function(){b.showCapture=!1},3e4)},webcamClose:function(){console.log("Webcam.webcamClose"),$("#webcam_success").hide(),$("#webcam_video").hide(),$("#canvas").hide(),$("#webcam_loaded_buttons").hide(),$("#webcam_access_screen").hide(),$("#webcam_initial_image").show(),$("#webcam_button_init").show();var a=this.video.srcObject,b=a.getAudioTracks(),c=a.getVideoTracks();b.length&&b[0].stop(),c.length&&c[0].stop(),this.running=!1}};